...
public class Cookie implements Comparable<Cookie>, Serializable {
    ...
    public static final long LLDP_POST_INGRESS_COOKIE                   = 0x0FL | DEFAULT_RULE_FLAG;
    ...
    public static final long LLDP_INPUT_ISL_VLAN_TYPE                = 0x0070_0000_0000_0000L;
     ...
     */
    public static boolean isLldpFlow(long value) {
