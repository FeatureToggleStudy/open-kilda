...
class MflStatSpec extends HealthCheckSpecification {
    ...
    def "System is able to collect stats from the statistic and management controllers"() {
        ...
        def statsBlockData = lockKeeper.knockoutSwitch(srcSwitch, statsFlFactory)
        ...
        def mgmtBlockData = lockKeeper.knockoutSwitch(srcSwitch, mgmtFlFactory)
        ...
        statsBlockData = lockKeeper.knockoutSwitch(srcSwitch, statsFlFactory)
