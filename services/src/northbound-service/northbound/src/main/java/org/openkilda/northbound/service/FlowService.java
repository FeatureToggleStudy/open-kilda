...
public interface FlowService {
     ...
     * @return created flow
     */
    CompletableFuture<FlowResponsePayload> createFlow(FlowCreatePayload flow);
     ...
     * @return created flow
     */
    CompletableFuture<FlowResponseV2> createFlow(FlowRequestV2 flow);
     ...
     * @return deleted flow
     */
    CompletableFuture<FlowResponsePayload> deleteFlow(String id);
     ...
     * @return deleted flow
     */
    CompletableFuture<FlowResponseV2> deleteFlowV2(String id);
     ...
     * @return updated flow
     */
    CompletableFuture<FlowResponsePayload> updateFlow(FlowUpdatePayload flow);
     ...
     * @return updated flow
     */
    CompletableFuture<FlowResponsePayload> patchFlow(String flowId, FlowPatchDto flowPatchDto);
     ...
     * @return flow
     */
    CompletableFuture<FlowResponsePayload> getFlow(String id);
     ...
     * @return flow status
     */
    CompletableFuture<FlowIdStatusPayload> statusFlow(String id);
     ...
     * @return Flow path
     */
    CompletableFuture<FlowPathPayload> pathFlow(String id);
     ...
     */
    CompletableFuture<BatchResults> pushFlows(List<FlowInfoData> externalFlows, Boolean propagate,
                                              Boolean verify);
     ...
     * @param verify        if true, we'll wait up to poll seconds to confirm if rules have been applied
     */
    CompletableFuture<BatchResults> unpushFlows(List<FlowInfoData> externalFlows, Boolean propagate,
                                                Boolean verify);
     ...
     */
    CompletableFuture<FlowReroutePayload> rerouteFlow(String flowId);
     ...
     * @return flow payload.
     */
    CompletableFuture<FlowResponsePayload> swapFlowPaths(String flowId);
     ...
     * @return updated flow path information with the result whether or not path was changed.
     */
    CompletableFuture<FlowRerouteResponseV2> rerouteFlowV2(String flowId);
     ...
     * @return updated flow.
     */
    CompletableFuture<FlowReroutePayload> syncFlow(String flowId);
     ...
     */
    CompletableFuture<List<FlowValidationDto>> validateFlow(String flowId);
